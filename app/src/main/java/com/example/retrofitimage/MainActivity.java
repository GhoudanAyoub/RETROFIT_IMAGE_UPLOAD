...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl("http://joy-technologies-ltd.com/test/")
    ...
    private void ImageUpload(Bitmap bitmap) {
        ...
        call.enqueue(new Callback<ResponseClass>() {
            @Override
            public void onResponse(@Nullable Call<ResponseClass> call, @Nullable Response<ResponseClass> response) {
            ...
            @Override
            public void onFailure(@Nullable Call<ResponseClass> call, @Nullable Throwable t) {
